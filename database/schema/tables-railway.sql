-- KANGO Smart Bus Navigation Database Schema (Railway Compatible)
-- Version 1.0
-- This file creates tables in the existing Railway database
...
-- Add foreign key for crew's assigned bus (only if not exists)
-- Note: This may fail if already added, which is OK
