...
try {
    ...
    $tables = [
        ...
        'crew' => "CREATE TABLE IF NOT EXISTS crew (
            id INT AUTO_INCREMENT PRIMARY KEY,
        ...
        'route_stops' => "CREATE TABLE IF NOT EXISTS route_stops (
            id INT AUTO_INCREMENT PRIMARY KEY,
        ...
        'wait_requests' => "CREATE TABLE IF NOT EXISTS wait_requests (
            id INT AUTO_INCREMENT PRIMARY KEY,
            user_id INT NOT NULL,
            bus_id INT NOT NULL,
            stop_id INT NOT NULL,
        ...
        'emergency_alerts' => "CREATE TABLE IF NOT EXISTS emergency_alerts (
            id INT AUTO_INCREMENT PRIMARY KEY,
            user_id INT NOT NULL,
            trip_id INT,
            bus_id INT,
        ...
        'saved_locations' => "CREATE TABLE IF NOT EXISTS saved_locations (
            id INT AUTO_INCREMENT PRIMARY KEY,
            user_id INT NOT NULL,
        ...
        'crew_reports' => "CREATE TABLE IF NOT EXISTS crew_reports (
            id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    echo "\n⚠️  DELETE migrate.php and remove /migrate route after running!\n";
